package com.easytox.automation.steps.ET_PL.ET_PL_009;
...
public class ET_PL_009_verify_pagination {
    ...
    public ET_PL_009_verify_pagination() {
    ...
    public void Checking_the_message_of_no_of_records_displayed_on_the_current_page_bottom_left_corner_of_the_screen() throws Throwable {
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath(".//*[@id='maincontentdiv']/div[8]/div/div/div/div[1]/div/a[1]")).click();
    ...
    public void A_text_message_Showing_x_to_y_of_z_entries_should_be_displayed_on_the_bottom_left_corner_of_the_list() throws Throwable {
        ...
        driver.findElement(By.xpath(".//*[@id='maincontentdiv']/div[8]/div/div/div/div[1]/div/a[1]/i")).click();
        Thread.sleep(2000);
        driver.quit();
    }
