package com.easytox.automation.steps.ET_PL.ET_PL_003;
...
public class ET_PL_003_Addinga_new_Patient {
    ...
    public ET_PL_003_Addinga_new_Patient() {
    ...
    public void screen_should_be_displayed(String arg1) throws Throwable {
        ...
        Thread.sleep(4000);
        driver.findElement(By.xpath(".//*[@id='addPatientdiv']/div[1]/button")).click();
        driver.quit();
