package com.easytox.automation.steps.ET_PL.ET_PL_008;
...
public class ET_PL_008_verify_insurance_details {
	...
	public ET_PL_008_verify_insurance_details(){
	...
	public void Click_on_umberella_Sign_under_action_column() throws Throwable {
	    
		
		Thread.sleep(2000);

		driver.findElement(By.xpath(".//*[@id='insurancelist']/i")).click();
		
		Thread.sleep(1000);
	}

	@Then("^\"([^\"]*)\" screen should be popup$")
	public void screen_should_be_popup(String arg1) throws Throwable {
