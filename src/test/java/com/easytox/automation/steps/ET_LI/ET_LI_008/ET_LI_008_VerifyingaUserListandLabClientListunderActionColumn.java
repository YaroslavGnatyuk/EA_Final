package com.easytox.automation.steps.ET_LI.ET_LI_008;
...
public class ET_LI_008_VerifyingaUserListandLabClientListunderActionColumn {
	...
	public ET_LI_008_VerifyingaUserListandLabClientListunderActionColumn(){
	...
	public void Click_on_list_icon_under_Action_Column() throws Throwable {
		Thread.sleep(2000);
	    driver.findElement(By.xpath(".//*[@id='sidebar']/ul/li[1]/a")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath(".//*[@id='lablist']/tbody/tr[1]/td[5]/div/div[2]/form/a/i")).click();
