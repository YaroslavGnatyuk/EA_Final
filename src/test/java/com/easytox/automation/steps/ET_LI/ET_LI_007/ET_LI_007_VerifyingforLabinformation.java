package com.easytox.automation.steps.ET_LI.ET_LI_007;
...
public class ET_LI_007_VerifyingforLabinformation {
	...
	public ET_LI_007_VerifyingforLabinformation (){
	...
	public void Click_on_icon_against_the_lab_record_in_results_list(String arg1) throws Throwable {
	  
		Thread.sleep(2000);
		
		driver.findElement(By.xpath(".//*[@id='lablist']/tbody/tr[1]/td[1]")).click();
		
		
	}

	@Then("^respected values should be populated such as created and modified users details$")
	public void respected_values_should_be_populated_such_as_created_and_modified_users_details() throws Throwable {
